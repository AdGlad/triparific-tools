...
def parse_args():
    ...
    p.add_argument("--fit-mode", choices=["pad", "crop", "stretch"], default="pad",
                   help="pad: fit inside with padding; crop: fill then center-crop; stretch: resize to exact 1:2 ratio.")
    return p.parse_args()
...
def make_uniform_tile(img_path, box_h, ratio_w_over_h=2.0, fit_mode="pad"):
    ...
    fit_mode:
      ...
      - 'stretch': non-uniformly resize to exactly (box_w, box_h) (aspect ratio not preserved).
    """
